...
namespace BatBetInfrastructure.Data.Migrations
{
    ...
    [Migration("20240416202858_UserTableDropUseIdentityUserTable")]
    partial class UserTableDropUseIdentityUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BatBetDomain.Entities.AvailableBet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2024, 4, 16, 20, 28, 57, 877, DateTimeKind.Utc).AddTicks(574));
            ...
            modelBuilder.Entity("BatBetDomain.Entities.Bet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 4, 16, 20, 28, 57, 877, DateTimeKind.Utc).AddTicks(3570));
            ...
            modelBuilder.Entity("BatBetDomain.Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 4, 16, 20, 28, 57, 877, DateTimeKind.Utc).AddTicks(5679));
            ...
            modelBuilder.Entity("BatBetDomain.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2024, 4, 16, 20, 28, 57, 877, DateTimeKind.Utc).AddTicks(7892));
